...
jedzenie = ctrl.Consequent(np.arange(0, 10.01, 0.01), 'jedzenie')
...
napiwek_sym.input['obsluga'] = 0 # wartosc napiwku wynosi: 5.076578013816947
#napiwek_sym.input['obsluga'] = 10 # wartosc napiwku wynosi: 24.923421986182834
napiwek_sym.compute()
...
napiwek_sym.compute()
print('Wynik', wynik_sym.output['napiwek'])
napiwek.view(sim=napiwek_sym)
