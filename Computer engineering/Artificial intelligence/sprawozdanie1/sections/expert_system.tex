...
\lstinputlisting[firstline=10, lastline=16]{./code/main.py}
...
\lstinputlisting[firstline=21, lastline=22]{./code/main.py}

\subsubsection{Definicja reguł}\label{ssc:definicja_regul}

W tej sekcji definiujemy reguły.

\lstinputlisting[firstline=25, lastline=27]{./code/main.py}
...
\lstinputlisting[firstline=31, lastline=32]{./code/main.py}
...
\lstinputlisting[firstline=35,lastline=39]{./code/main.py}
...
\lstinputlisting[firstline=41, lastline=53]{./code/main.py}
...
\lstinputlisting[firstline=8, lastline=8]{./code/main.py}
\lstinputlisting[firstline=18, lastline=19]{./code/main.py}
...
\lstinputlisting[firstline=28, lastline=29]{./code/main.py}
...
\lstinputlisting[firstline=34, lastline=39]{./code/main.py}
...
\lstinputlisting[firstline=55,lastline=75]{./code/main.py}
